...
def get_dummy_config(include_text: bool):
    return SharepointRunConfig(
...
@patch("metaphor.sharepoint.extractor.embed_documents")
@pytest.mark.asyncio
async def test_extract_no_include(
    mock_embed_docs: MagicMock,
    mock_get_sites: MagicMock,
    sharepoint_extractor,
    test_root_dir: str,
    ...
    # Load the expected result for comparison
    expected_events = load_json(f"{test_root_dir}/sharepoint/expected_no_text.json")
