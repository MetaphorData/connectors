...
async def test_extractor(
    ...
    mock_latest_history = MagicMock()
    mock_latest_history.asDict = MagicMock()
    mock_latest_history.asDict.return_value = {
    ...
    mock_cursor.fetchone.return_value = mock_latest_history
