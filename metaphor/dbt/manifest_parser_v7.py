...
# compiled node has 'compiled_code' field
...
class ManifestParserV7:
    """
    dbt manifest parser, using v7 schema https://schemas.getdbt.com/dbt/manifest/v7.json
    """
    ...
    def _parse_metric(
        ...
        metric_entity.dbt_metric = DbtMetric(
            ...
            type=metric.calculation_method,
